  ...
  Widget build(BuildContext context) {
    ...
    Future<void> fetchItems() async {
      try {
        ...
        final itemList = response.map((data) => Item.fromJson(data)).toList();
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) => ItemDetailScreen(
                  item: item,
                  onItemDeleted: fetchItems, // Refresh if item is deleted
                ),
              ),
            );
          },
          child: Column(
            // ← MOVE your existing Column inside InkWell
              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        Navigator.pushNamed(context, '/create_item').then((
                          refresh,
                        ) {
                          if (refresh == true) {
                            fetchItems();
